...
export default function Privacy() {
  const metaTitle = 'useaffiliates.com - privacy policy';
  ...
  return (
    <>
      ...
      <DefaultLayout title="Privacy Policy" isSmall>
          ...
          <section className="bg-white relative -mt-8 mb:-mt-24 lg:-mx-6 rounded shadow-md px-6 py-4 md:py-8">
            <div className="grid--default">
              <div className="col-span-12 md:col-span-8 md:col-start-3 wysiwyg">
                <p>
                  At useaffiliates.com, accessible from useaffiliates.com, one
                  of our main priorities is the privacy of our visitors. This
                  Privacy Policy document contains types of information that is
                  collected and recorded by useaffiliates.com and how we use it.
                </p>
                ...
                <p>
                  useaffiliates legal basis for collecting and using the
                  personal information described in this Privacy Policy depends
                  on the Personal Information we collect and the specific
                  context in which we collect the information:
                </p>
                <ul>
                  <li>useaffiliates needs to perform a contract with you</li>
                  <li>You have given useaffiliates permission to do so</li>
                  <li>
                    Processing your personal information is in useaffiliates
                    legitimate interests
                  </li>
                  <li>useaffiliates needs to comply with the law</li>
                </ul>

                <p>
                  useaffiliates will retain your personal information only for
                ...
                <p>
                  useaffiliates.com follows a standard procedure of using log
                ...
                <p>
                  ...
                  of the advertising partners of useaffiliates.com.
                </p>
                ...
                <p>
                  ...
                  useaffiliates.com, which are sent directly to users&#39;
                ...
                <p>
                  Note that useaffiliates.com has no access to or control over
                ...
                <p>
                  useaffiliates.com&#39;s Privacy Policy does not apply to other
                ...
                <p>
                  useaffiliates.com does not knowingly collect any Personal
                ...
                <p>
                  ...
                  and/or collect in useaffiliates.com. This policy is not
